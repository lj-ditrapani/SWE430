...
<head>
	...
	<title>SWE 430 Lesson 2.1 Tools and Standards</title>
...
<p>
Lutz Prechelt, in his paper, <a href="http://wwwipd.ira.uka.de/~prechelt/Biblio/jccpprtTR.pdf">An Empirical Comparison of C, C++, Java, Perl, Python, Rexx, and Tcl</a>, showed how scripting languages typically produce shorter programs when compared to non-scripting languages and often affected the choices in data structures (the programs written in scripting languages were more apt to use dictionaries.)  He states: <span class=emph>"We see that non-scripts are typically two to three times as long as scripts. Even the longest scripts are shorter than the average non-script."</span> However, it is important to keep in mind the choice of actual developers is much more important than the choice of language, as the author's research shows "<span class=emph>Differences between programmers outweigh differences between languages</span>".
</p>
...
<dt>97TEPSK</dt>
<dd>
Henney, Kevlin.  <span class=emph>97 Things Every Programmer Should Know</span>, 2010
</dd>
</dl>
